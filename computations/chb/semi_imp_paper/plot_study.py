...
df_types = {
    "gamma": {"Total # iterations": df_gamma_iter, "Total simulation time": df_gamma_time},
    "swelling": {"Total # iterations": df_swelling_iter, "Total simulation time": df_swelling_time},
}
