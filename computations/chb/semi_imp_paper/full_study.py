...
with Progress() as p:
    t = p.add_task(
        "Running all combinations of simulations...",
        total=(len(gamma_values) + len(swelling_values)) * 6,
    )
...
iteration_df_swelling = pd.DataFrame(
    total_iteration_data_swelling, index=swelling_values
)
